<form class="form-inline" method="post" action="/Film/AddPost">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="film_name" id="filmName" value="<?= $film['name'] ?>">
    </div>

    <div class="form-group">
        <label for="filmYear">Year</label>
        <input type="number" class="form-control" name="film_year" id="filmYear" value="<?= $film['year'] ?>">
    </div>

    <div class="form-group">
        <label for="filmFormat">Format</label>
        <select class="form-control" name="film_format" id="filmFormat" value="<?= $film['format'] ?>">
            <option>VHS</option>
            <option>DVD</option>
